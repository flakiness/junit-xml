...
```bash
git clone https://github.com/flakiness/junit-xml.git fk-junit-xml
cd fk-junit-xml
pnpm install
```
...
3. [Create a GitHub Release](https://github.com/flakiness/junit-xml/releases/new) for the new tag and publish it.
